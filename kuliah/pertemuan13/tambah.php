        ...
        <div class="card d-flex justify-content-center">
          ...
          <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <img src="img/nophoto.jpg" width="120px" class="mb-3 img-preview">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="gambarAddon">Gambar</span>
                </div>
                <div class="custom-file">
                  <input type="file" class="custom-file-input gambar-input" id="gambar" aria-describedby="gambarAddon" name="gambar" onchange="previewImage()">
