    ...
    <div class="columns">
      ...
      <div class="column">
        ...
        <section class="section has-background-secondary has-margin-top-5" style="margin-top: -3rem">
          ...
          <div class="container is-fluid" style="padding-bottom: 1rem">
            <a class="button is-warning" href="admin.php?site=alat-musik-tambah">Tambah Data</a>
          </div>

          <div class="container is-fluid">
            <div v-if="sortedData.length > 0">
              <div class="box" v-for="am in sortedData" :key="am.id">
                <article class="media">
